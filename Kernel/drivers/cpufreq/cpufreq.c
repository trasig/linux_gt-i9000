...
int exp_UV_mV[8] = {0,0,0,0,0,0,0,0};
int active_states[8] = {0,0,0,1,1,1,1,1};
					...
					const char *buf, size_t count)
{
	...
	ret = sscanf(buf, "%d %d %d %d %d %d %d %d %d %d", &exp_UV_mV[0],&exp_UV_mV[1],&exp_UV_mV[2],&exp_UV_mV[3],&exp_UV_mV[4],&exp_UV_mV[5],&exp_UV_mV[6],&exp_UV_mV[7]);
	if (ret != 1)
		return -EINVAL;
	else 
		return count;
